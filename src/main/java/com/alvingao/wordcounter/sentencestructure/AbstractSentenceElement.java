...
/**
 * Abstract class implementing {@code SentenceElement} providing functionality for {@code SentenceElement}s.
 */
public abstract class AbstractSentenceElement implements SentenceElement {
    private final String value;

    /**
     * Constructs an instance of {@code AbstractSentenceElement} with {@code value} as its string representation.
    ...
    /**
     * Constructs an instance of {@code AbstractSentenceElement} as a copy of {@code element}.
